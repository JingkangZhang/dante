...
const POEM_EXPLAIN = [
  ...
  <br /><br />Fun fact: Cary and Longfellow's translations of <em>Inferno</em> are in blank verse (which are much better than my verse). I borrowed certain words from them, such as "retrace".</div>),
